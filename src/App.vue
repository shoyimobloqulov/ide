<template>
    <div class="m-2">
        <div class="row">
            <div class="col-md-8">
                <CodeEditor v-model="code" :theme="theme" width="100%" height="95vh" :languages="languages">
                </CodeEditor>
            </div>
            <div class="col-md-4">
                <form role="form">
                    <div class="form-group">
                        <label for="name">Theme selector</label>
                        <select class="form-select pt-1 form-control" aria-label="Theme selector" v-model="theme"
                            @change="onChangeLang">
                    ...
                    <br>
                    <div class="form-group">
                        <label for="name">Input details</label>
                        <textarea class="form-control" v-model="input" rows="3" placeholder="Input details"></textarea>
                    </div>
                    <br>
                    <div class="form-group">
